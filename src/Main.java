public class Main {
    public static void main(String[] argv){
        ...
        Lecon POO1 = new Lecon("POO", "H02", 2, 5, 2);
        Lecon POO2 = new Lecon("POO", "H02", 3, 5, 2);
        Lecon POO3 = new Lecon("POO", "H02", 3, 7, 2);
        Lecon SYE1 = new Lecon("SYE", "G01", 0, 0, 2);
        Lecon SYE2 = new Lecon("SYE", "H01", 3, 2, 2);
